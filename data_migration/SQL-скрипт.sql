...
create table public.shipping_status(
	shippingid bigint primary key,
	status text, --ñòàòóñ äîñòàâêè â òàáëèöå shipping ïî äàííîìó shippingid. Ìîæåò ïðèíèìàòü çíà÷åíèÿ in_progress — äîñòàâêà â ïðîöåññå, ëèáî finished — äîñòàâêà çàâåðøåíà--
	state text,  --ïðîìåæóòî÷íûå òî÷êè çàêàçà, êîòîðûå èçìåíÿþòñÿ â ñîîòâåòñòâèè ñ îáíîâëåíèåì èíôîðìàöèè î äîñòàâêå ïî âðåìåíè state_datetime
